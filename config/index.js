...
export const CONFIG = {
  ...
  DEFAULT: {
    ...
    FILE_SYSTEM: {
      ...
      COMPANY_PICTURE: 'default-company.png',
      PRODUCT_PICTURE: 'default-product.png',
      TEMP_PRODUCT_PICTURE: 'default-temp-product.png',
    }
  },
  ...
  STORAGE: {
    ...
    PRODUCT_TEMPORARY: ENV_CONFIG.PRODUCT_TEMPORARY_STORAGE_KEY,
  },
